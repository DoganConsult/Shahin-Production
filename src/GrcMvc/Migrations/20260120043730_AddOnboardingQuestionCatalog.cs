...
{
    /// <inheritdoc />
    public partial class AddOnboardingQuestionCatalog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropPrimaryKey(
                name: "PK_ValidationRules",
                table: "ValidationRules");

            migrationBuilder.RenameTable(
                name: "ValidationRules",
                newName: "ValidationRule");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnboardingSections", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionAr = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    HelpTextEn = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    HelpTextAr = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    PlaceholderEn = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    PlaceholderAr = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    IsRequired = table.Column<bool>(type: "boolean", nullable: false),
                    ConditionalDisplayJson = table.Column<string>(type: "text", nullable: false),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OnboardingQuestions_OnboardingSections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "OnboardingSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "OnboardingSectionProgress",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnboardingSectionProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OnboardingSectionProgress_OnboardingSections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "OnboardingSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OnboardingSectionProgress_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnsweredByUserId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    IsValidated = table.Column<bool>(type: "boolean", nullable: false),
                    ValidationNotes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    ModifiedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OnboardingAnswers_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessReviewItems_ReviewId",
                table: "AccessReviewItems",
                column: "ReviewId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessReviews_TenantId",
                table: "AccessReviews",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingAnswers_AnsweredAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnboardingAnswers_TenantId",
                table: "OnboardingAnswers",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingAnswers_TenantId_QuestionId",
                table: "OnboardingAnswers",
                columns: new[] { "TenantId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingQuestions_Code",
                table: "OnboardingQuestions",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingQuestions_FieldName",
                table: "OnboardingQuestions",
                column: "FieldName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingQuestions_IsActive",
                table: "OnboardingQuestions",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingQuestions_IsRequired",
                table: "OnboardingQuestions",
                column: "IsRequired");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingQuestions_SectionId_SortOrder",
                table: "OnboardingQuestions",
                columns: new[] { "SectionId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingSectionProgress_SectionId",
                table: "OnboardingSectionProgress",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingSectionProgress_Status",
                table: "OnboardingSectionProgress",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingSectionProgress_TenantId",
                table: "OnboardingSectionProgress",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingSectionProgress_TenantId_SectionId",
                table: "OnboardingSectionProgress",
                columns: new[] { "TenantId", "SectionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingSections_Code",
                table: "OnboardingSections",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OnboardingSections_SortOrder",
                table: "OnboardingSections",
                column: "SortOrder");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ValidationResults_ValidationRule_ValidationRuleId",
                table: "ValidationResults",
