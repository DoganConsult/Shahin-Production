    ...
    >
      ...
      >
        <div className="max-w-4xl">
          ...
          >
            {/* Start Trial Button */}
            <a href="http://localhost:5100/Account/Register" target="_blank" rel="noopener noreferrer">
            ...
            <a href="http://localhost:5100/Account/Login" target="_blank" rel="noopener noreferrer">
